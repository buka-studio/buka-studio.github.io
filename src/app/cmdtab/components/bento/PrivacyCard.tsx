...
import ShieldInner from "../../../../../public/cmdtab/bento/shield-inner.svg";
import ShieldOutline from "../../../../../public/cmdtab/bento/shield-outline.svg";
import Shield from "../../../../../public/cmdtab/bento/shield.svg";

import { useAnimationFrame } from "framer-motion";
import DownloadIcon from "../../../../../public/cmdtab/download.svg";
...
export default function PrivacyCard({ className }: { className?: string }) {
  ...
  return (
    <BentoCard
      ...
      className={className}
      illustration={
        <div className="shield-container relative h-full w-full group">
          <CanvasSwitchboard animating={hovering} />
          <ShieldOutline className="shield-outline absolute left-1/2 translate-x-[-50%] top-1/2 translate-y-[-50%]" />
          <Shield className="shield absolute left-1/2 translate-x-[-50%] top-1/2 translate-y-[-50%]" />
          <ShieldInner className="shield-inner absolute left-1/2 translate-x-[-50%] top-1/2 translate-y-[-50%] opacity-0" />
        </div>
      }
    >
      <div>
        ...
        <p className="text-balance text-neutral-400 text-left">
          Your data is stored exclusively on your browser and is not shared with
          anyone.
        </p>
      </div>
    </BentoCard>
